...
register(
    id='WARGAME-SIM-v0',
    entry_point='gym.envs.wargame.RL_ENV:Lanchester',
    kwargs={'NBR_RED_AGENTS': 2, 
            'NBR_BLUE_AGENTS': 2, 
            'MAP_WIDTH': 9, 
            'BLUE_ALPHA': 0, #probability of taking BLUE_ACTION (1-alpha)=probability of random action
            'BLUE_ACTION': 'STATIONERY', 
            'BLUE_START_DIR': 'S', 
            'RED_START_DIR': 'N', 
            'COMBAT_MODEL': 'deterministic'
           }, 
